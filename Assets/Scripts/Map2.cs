...
public class Map2 : MonoBehaviour
{
	...
	public void UpdateImagePos(GameObject ImageObj, int index)
	{
		...
		{
		case 0:
			ImageObj.transform.localPosition = new Vector2(x / 2f, y / 2f * 3f);
			break;
		case 1:
			ImageObj.transform.localPosition = new Vector2(x / 2f * 3f, y / 2f * 3f);
			break;
		case 2:
			ImageObj.transform.localPosition = new Vector2(x / 2f, y / 2f);
			break;
		case 3:
